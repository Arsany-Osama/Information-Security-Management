...
# Function to analyze total, GET, POST, and other request counts
...
# Function to analyze unique IP addresses and their GET/POST counts
analyze_unique_ips() {
...
# Function to analyze failed requests (4xx/5xx) and their percentage
...
# Function to calculate average requests per day
...
# Function to identify days with the highest failure requests
...
# Function to calculate requests per hour (per day and across all days)
...
# Function to identify request trends
...
# Function to provide status code breakdown
...
# Function to identify most active IPs by GET and POST methods
...
# Function to identify patterns in failure requests (by hour and day)
